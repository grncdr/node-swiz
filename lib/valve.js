...
var ipv6 = require('javascript-ipv6').v6;
var net = require('net');
 ...
 */
var validate_schema = function(schema, object) {
  ...
  for (propname in schema) {
    ...
    if (object.hasOwnProperty(propname)) {
      ...
      /* validate the chain, on error throw an exception */
...
exports.check = function(schema, object) {
  ...
  try {
    rv.cleaned = validate_schema(schema, object);
    rv.is_valid = true;
    rv.errors = null;
  } catch (e) {
    rv.cleaned = null;
