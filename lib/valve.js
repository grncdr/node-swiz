 ...
 */
function checkChain(value, chain, callback) {
  async.reduce(chain.validators.map(function(i) {
                  return i.func;
                }),
                null,
 ...
 */
function checkSchema(obj, schema, parentKeys, isPartial, callback) {
  var key,
      chain;
  ...
  async.reduce(Object.keys(schema), {}, function(cleanedObj, 
    ...
    if (obj.hasOwnProperty(key)) {
      if (chain instanceof Chain) {
        ...
        parentKeys.push(key);
        checkSchema(obj[key], chain, parentKeys, isPartial,
