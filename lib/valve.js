 ...
 */
var checkChain = function(value, chain, callback) {
  async.reduce(chain.validators.map(function(i) {return i.func;}), 
               null,
               function(memo, validator, callback) {
                 validator(value, function(err, result) {
                   var message;
                   if (err) {
 ...
 *
 * @function
 * @param {Chain} The validator chain
 * @returns {Array} an array of documentation strings
 */
var chainHelp = function(chain) {
  return chain.validators.map(function(e) { return e.help; })
 ...
 *
 * @constructor
 * @returns {Chain} A validator chain object.
 */
var Chain = function() {
...
/**
 * Adds a validator to the chain to ensure that the given value is a
 * non-blacklisted IP address.
 *
 * @returns {Chain} The validator chain to which the validator was added
 */
Chain.prototype.notIPBlacklisted = function() {
  this.validators.push({
    func: function(value, callback) {
      ...
      for (i = 0; i < ipBlacklist[ipVersion].length; i++) {
...
/**
 * Adds a validator to the chain to ensure that the given value is expressed in
 * valid CIDR notation.
 *
 * @returns {Chain} The validator chain to which the validator was added
 */
...
/**
 * Adds a validator to the chain to ensure that the given value is an
 * alphabetical string.
 *
 * @returns {Chain} The validator chain to which the validator was added
 */
...
/**
 * Adds a validator to the chain to ensure that the given value (either a
 * number or string) contains only numbers.  If the given value is a number, it
...
/**
 * Adds a validator to the chain to ensure that the given value is a lowercase
 * string.
 *
 * @returns {Chain} The validator chain to which the validator was added
 */
...
/**
 * Adds a validator to the chain to ensure that the given value is an uppercase
 * string.
 *
 * @returns {Chain} The validator chain to which the validator was added
 */
...
/**
 * Adds a validator to the chain to ensure that the given value is not
...
/**
 * Adds a validator to the chain to ensure that the given value is
 * null or an empty string.
 *
 * @returns {Chain} The validator chain to which the validator was added
 */
...
/**
 * Adds a validator to the chain to ensure that the given value is
 * a equal to (but not necessarily the same type as) the provided argument.
 *
...
/**
 * Adds a validator to the chain to ensure that the given value contains
 * the provided argument as a substring.
 *
...
/**
 * Adds a validator to the chain to ensure that the given value does not
...
/**
 * Adds a validator to the chain to ensure that the given value matches
 * the regular expression provided in the argument.
 *
 * @param {String} pattern The regular expression against which the value must match
 * @param {String} [modifiers] Regular expression modifiers (e.g., 's', 'i', 'm')
 * @returns {Chain} The validator chain to which the validator was added
 */
...
/**
 * Adds a validator to the chain to ensure that the given value does not match
 * the regular expression provided in the argument.
 *
 * @param {String} pattern The regular expression against which the value must not match
 * @param {String} [modifiers] Regular expression modifiers (e.g., 's', 'i', 'm')
 * @returns {Chain} The validator chain to which the validator was added
 */
...
/**
 * Adds a validator to the chain to ensure that the length of the given value
 * is between the minimum and maximum lengths provided in the arguments.  If no
 * maximum length argument is provided, the length of given value must
...
/**
 * Adds a validator to the chain to convert a given value to the Boolean value
 * true unless the given value is 0, '0', false, 'false', null, or its length
 * is 0.
 *
 * @returns {Chain} The validator chain to which the validator was added
 */
...
/**
 * Adds a validator to the chain to convert a given value to the Boolean 
...
/**
 * Adds a validator to the chain to convert HTML entities in the given value
 ...
 * in the given value as HTML entities.
 *
 * @returns {Chain} The validator chain to which the validator was added
 */
 ...
 * characters from the given value.  If no argument is specified, whitespace
 * will be removed by default.
 *
 * @param {String} [chars] A list of characters to be removed (default: whitespace)
 * @returns {Chain} The validator chain to which the validator was added
 */
...
/**
 * Adds a validator to the chain to remove the specified leading 
 * characters from the given value.  If no argument is specified, whitespace
 * will be removed by default.
 *
 * @param {String} [chars] A list of leading characters to be removed (default: whitespace)
 * @returns {Chain} The validator chain to which the validator was added
 */
...
/**
 * Adds a validator to the chain to remove the specified trailing 
 * characters from the given value.  If no argument is specified, whitespace
 * will be removed by default.
 *
 * @param {String} [chars] A list of leading characters to be removed (default: whitespace)
...
/**
 * Adds a validator to the chain that will substitute a null value in
 * the validated data with the specified replacement.
 *
...
/**
 * Adds a validator to the chain that replaces enumerated values (keys in
 * the specified map) with their replacements (values in the specified map)
...
Chain.prototype.optional = function() {
  ...
  this.validators.unshift({
    func: function(value, callback) { callback(null, value); },
    help: 'Optional'
  });
  return this;
};
...
Chain.prototype.isArray = function(chain) {
  this.validators.push({
    func: function(value, callback) {
      ...
      async.map(value, 
                function(item, itercb) { checkChain(item, chain, itercb); },
                callback);
    },
...
Chain.prototype.isHash = function(keyChain, valueChain) {
  var iter = function(memo, item, callback) {
    ...
    checkChain(key, keyChain, function(err, cleanedKey) {
        if (err) {
          callback('Key ' + key + ': ' + err);
        } else {
          checkChain(value, valueChain, function(err, cleanedValue) {
            if (err) {
  ...
  this.validators.push({
    func: function(value, callback) {
      ...
      async.reduce(kvpairs, {}, iter, callback);
    },
 ...
 * @param {Array} parentKeys The schema's parent keys (if this schema is a subschema)
 ...
 */
var checkSchema = function(obj, schema, parentKeys, isPartial, callback) {
  var key,
      chain;

  async.reduce(Object.keys(schema), {}, function(cleanedObj, key, reduceCallback) {
    chain = schema[key];
    if (obj.hasOwnProperty(key)) {
      if (chain instanceof Chain) {
        checkChain(obj[key], chain, function(err, cleanedValue) {
            var message;
            if (err) {
              if (err.hasOwnProperty(message)) {
                message = err.message;
        ...
        parentKeys.push(key);
        checkSchema(obj[key], chain, parentKeys, isPartial, function(err, cleanedValue) {
          if (err) { 
            reduceCallback(err); 
          } else {
            cleanedObj[key] = cleanedValue;
    ...
    } else if (isPartial || chain.isOptional) {
      reduceCallback(null, cleanedObj);
    } else {
      reduceCallback({ key: key,
                       parentKeys: parentKeys,
 ...
 *
 * @param {Object} schema The object to be tested/converted
 * @param {Function(err, result)} callback The callback that will be invoked 
 *  with the "cleaned" (tested/converted) object
 */
Valve.prototype.check = function(obj, callback) {
  ...
  checkSchema(obj, this.schema, [], false, callback);
};
...
Valve.prototype.checkPartial = function(obj, callback) {
  ...
  checkSchema(obj, this.schema, [], true, callback);
};
 ...
 * @returns {Object} An object containing a description of the schema, indexed
 *  by key
 */
Valve.prototype.help = function(schema) {
  ...
  for (key in schema) {
    chain = schema[key];
    help[key] = (chain instanceof Chain) ? chainHelp(chain) : this.help(chain);
  }
  return help;
};
